...
Artifact preservation, format grammars (task / requirement / success-criterion / checklist / bug-task / stress-test-finding), and section rules live in `references/shared-skills/artifact-conventions/SKILL.md`. Do not duplicate them here.
